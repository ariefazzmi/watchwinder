...
void speedUpdate(int moto, int rotCount){
  if(moto==1){
    String  val1 = String(rotCount/2048);
    myGLCD.setTextColor(TFT_BLACK);
    myGLCD.setTextSize(3);
    myGLCD.fillRect(7, 195, 110, 40, TFT_WHITE);
    myGLCD.drawCentreString(val1, 63, 205, 1);
  } else if(moto==2){
    String val2 = String(rotCount/2048);
    myGLCD.setTextColor(TFT_BLACK);
    myGLCD.setTextSize(3);
    myGLCD.fillRect(7, 195, 110, 40, TFT_WHITE);
    myGLCD.drawCentreString(val2, 63, 205, 1);
  }
}
